...
import org.vudroid.core.cache.BitmapCache;
...
import org.vudroid.core.entity.DecodeTask;
import org.vudroid.core.utils.APageSizeLoader;
import org.vudroid.core.utils.CropUtils;
...
public class DecodeServiceBase implements DecodeService {
    ...
    public CodecDocument open(String path, boolean cachePage) {
        ...
        APageSizeLoader.PageSizeBean psb = APageSizeLoader.INSTANCE.loadPageSizeFromFile(containerView.getContext(), count, path);
        if (null != psb) {
            pageSizeBean = psb;
        ...
        try {
            ...
            if (cachePage) {
                APageSizeLoader.INSTANCE.savePageSizeToFile(containerView.getContext(), false, path, aPageList);
            }
        } catch (Exception e) {
